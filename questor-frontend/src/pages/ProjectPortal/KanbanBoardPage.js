...
function KanbanBoardPage() {
    ...
    const [newTask, setNewTask] = useState({ name: '', description: '', dueDate: '', priority: 'LOW', boardId: null });
            ...
            <div className="container mt-28 mx-auto p-4 overflow-x-auto">
                <div className="flex space-x-4">
                    ...
                    <div className="w-64 bg-gray-200 p-4 rounded-lg shadow-md">
                        <button onClick={() => setIsModalOpen(true)} className="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">
                            Add Board
                        </button>
                    </div>
                </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-md">
                        ...
                        <div className="flex justify-end space-x-4">
                            <button onClick={() => setIsModalOpen(false)} className="bg-gray-600 text-white py-2 px-4 rounded-full">
                                Cancel
                            </button>
                            <button onClick={handleCreateBoard} className="bg-indigo-600 text-white py-2 px-4 rounded-full">
                                Create
                            </button>
                        </div>
                    </div>
            ...
            {isTaskModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-md">
                        ...
                        <div className="flex justify-end space-x-4">
                            <button onClick={() => setIsTaskModalOpen(false)} className="bg-gray-600 text-white py-2 px-4 rounded-full">
                                Cancel
                            </button>
                            <button onClick={handleCreateTask} className="bg-indigo-600 text-white py-2 px-4 rounded-full">
                                Create
                            </button>
                        </div>
                    </div>
